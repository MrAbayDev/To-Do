@extends('layouts.app')
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-900 text-white">
        <div class="w-full max-w-md bg-gray-800 p-8 rounded-lg shadow-lg">
            <h2 class="text-3xl font-bold text-center mb-6">Ro'yxatdan O'tish</h2>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-400">Allaqachon hisobingiz bormi? <a href="{{ route('login') }}" class="text-blue-500 hover:text-blue-400">Kirish</a></p>
            </div>
        </div>
    </div>
